...
public class SCLoginCommand extends SCLoginMasterCommand
{
    ...
    public boolean execute(final CommandSender sender, final String[] args)
    {
        ...
        {
            for(Map.Entry<String, PlayerManager.Status> statusEntry : this.plugin.getPlayerManager().playerStatus.entrySet())
            {
            ...
            public void run()
            {
                switch (sub)
                {
                    ...
                    case UNLOCK:
                        ...
                        break;
                    case COUNT:
                        String count = SCLoginCommand.this.plugin.getPlayerManager().getCount(args[1]);
                        if (count == null)
                        {
                    ...
                    case SAFEGUARD:
                        ...
                        boolean activate = args[1].equals("true");
